...
class Order:
    ...
    def order_elements(self, order_elements_list):
        if len(order_elements_list) > Order.MAX_ORDER_ELEMENTS:
            self._order_elements = order_elements_list[0:Order.MAX_ORDER_ELEMENTS]
        else:
            self._order_elements = order_elements_list
    ...
    def get_discount_value(self):
        return self.discount_policy(self.calc_price_before_discount()) - self.calc_price_before_discount()
